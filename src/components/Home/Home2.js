      ...
      <Container>
        <Row>
          <Col md={8} className="home-about-description">
            ...
            Interested in Data Science and Web development. 
              ...
              <i>
                ...
                <b className="purple">
                  Cybersecurity, Devops and Product Management.
                </b>
              </i>
              <br />
              <br />
          ...
          <Col md={4} className="myAvtar">
            <Tilt>
              <img src={woman} className="img-fluid" alt="avatar" />
            </Tilt>
          </Col>
        </Row>
        <Row>
          <Col md={12} className="home-about-social">
            ...
            <ul className="home-about-social-links">
              <li className="social-icons">
                <a
                  href="https://github.com/sania089"
                  target="_blank"
                  rel="noreferrer"
              ...
              {/* <li className="social-icons">
                <a
                  href="https://leetcode.com/sania089/"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                >
              ...
              <li className="social-icons">
                <a
                  href="www.linkedin.com/in/sania-sarin-8524b3227"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                >
              ...
              {/* <li className="social-icons">
                <a
                  href="https://www.instagram.com/sanheea"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour home-social-icons"
                >
